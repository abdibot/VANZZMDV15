...
└───❑`
                let btn = [{
                            ...
                            kahfs = fs.readFileSync('media/VANZZOFC.mp4')
...
LIBRAY:  *BAILEYS MD*`, "VANZZOFC", "List Bor ", sectionnya, { quoted: m})
break
case 'grupmenu': {
	            anu = `
  *Group Menu*
